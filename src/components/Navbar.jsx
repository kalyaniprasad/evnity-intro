...
export default function Navbar() {
  ...
  const scrollTo = (id) => {
    ...
    if (element) {
      setMobileOpen(false)
      // Small timeout to allow the menu to close smoothly before scrolling if desired, 
      // but usually immediate is fine. Let's ensure it hits the target.
      setTimeout(() => {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 inset-x-0 z-[100] transition-all duration-500 ${
        scrolled
          ? 'glass shadow-lg border-b border-[#E2E8F0] py-0'
          : 'bg-transparent py-2'
      }`}
    >
        ...
        {mobileOpen && (
          <>
            ...
            <motion.div
              ...
              className="md:hidden absolute top-full left-5 right-5 mt-4 glass rounded-[2rem] shadow-premium overflow-hidden border border-[#E2E8F0] z-[100]"
            >
